...
public class InterfaceResidue {
    ...
    public String getStructutreResidueName() {
        return structureResidueName;
    }

    public void setStructutreResidueName(String structutreResidueName) {
        this.structureResidueName = structutreResidueName;
    }
    ...
    public String getPartnerChain() {
        return partnerChain;
    }

    public void setPartnerChain(String partnerChain) {
        this.partnerChain = partnerChain;
    }
